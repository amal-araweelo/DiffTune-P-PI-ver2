...
dim_controllerParameters = 3;  % dimension of controller parameters (k_pos, k_vel, k_i];
...
[h, v] = controller(X, Xref, k_vec, theta_r_dot, theta_r_2dot, v_temp, param, dt);
...
grad_h_X_fcn = Function('grad_h_X_fcn',{X, Xref, k_vec, theta_r_dot, theta_r_2dot, v_temp, N, J_m, dt},{grad_h_X});
grad_h_theta_fcn = Function('grad_h_theta_fcn',{X, Xref, k_vec, theta_r_dot, theta_r_2dot, v_temp, N, J_m, dt},{grad_h_theta});
